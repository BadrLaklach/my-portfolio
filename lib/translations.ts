export const translations = {
  fr: {
    ...
    about: {
      ...
      tags: {
        ...
        softwareEng: "Ingénierie Logicielle",
        mlAi: "ML & IA",
    ...
    contact: {
      ...
      form: {
        ...
        description: "N'hésitez pas à me contacter directement par email pour toute proposition de projet, d'emploi ou simplement pour échanger !",
      },
    },
    footer: {
      description:
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        title: "Let's connect",
        description: "Feel free to reach out to me directly via email for any project proposals, job opportunities, or just to chat!",
      },
    },
    footer: {
      description:
